@section('title', 'Quản lý gười dùng')

@section('page-bar')
{{ Form::bsPageBar('Quản lý gười dùng') }}
@endsection
...
<script src="{{ asset('/apps/scripts/' . Session::get('locale', 'en') . '/admin/user.index.js') }}" type="text/javascript"></script>
@endsection
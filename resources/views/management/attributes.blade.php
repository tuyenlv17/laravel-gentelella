...
@section('title', trans('general.attributes'))
        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li><a href="{{url('/management/attributes')}}"><i class="fa fa-plus" title="{{trans('general.add')}}"></i></a>
                    </li>
            ...
            <div class="x_content">
                ...
                {{ Form::open(array('url' => 'management/attributes', 'id' => 'attribute-form')) }}
                @else
                {{ Form::model($attribute, array('route' => ['attributes.update', $attribute->id], 'method' => 'PATCH', 'id' => 'attribute-form')) }}
                @endif
...
<script src="{{asset('/resources/js/management/attributes.js')}}"></script>
@stop